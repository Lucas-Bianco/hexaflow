...
export const parts = [
  ...
  },
  {
    ...
    description: 'Front access door allowing rapid swap of experiment modules without full disassembly.',
  ...
  },
  {
    ...
    description: 'Side doors for access to the cable-management cavities in the hollow walls.',
  ...
  },
  {
    ...
    description: 'The bottom piece of the TDC V2 assembly — forms the lower half of the hex-channel capillary network and connects to the water injector.',
  ...
  },
  {
    ...
    description: 'A resin addin for the TDC. Resin’s polar properties create stronger adhesion bonds with water than water molecules share with each other, enabling efficient capillary transport — the system can even retain water when inverted.',
    image: null,
    drawingFile: null,
  ...
  // ── Camera / LED ───────────────────────────────────────────────────────
  {
    ...
    description: 'Holds the root-zone camera and LED lighting. Includes an anti-glare strip to prevent lens flare during imaging so the vision model gets a clean read on root moisture.',
  ...
  },
  {
    ...
    description: 'A ball-and-socket mount giving the camera a range of adjustable angles for framing the root zone. Pair with the Ball + Socket Camera Holder.',
    image: null,
  ...
  // ── Water ──────────────────────────────────────────────────────────────
  {
    ...
    description: 'Located at the system base for hemisphere entry. Allows precise water introduction into the channel network. The injector hole can be sealed during drop tests.',
  ...
  },
  {
    ...
    description: 'A capacitive soil-moisture sensor probe that sits in the substrate through the cover opening and reports moisture directly.',
    image: null,
    drawingFile: null,
  ...
  },
  {
    ...
    description: 'A clip (and its USB-B connector parts) that mounts a secondary USB camera to observe the pump and reservoir, separate from the primary root-zone camera.',
